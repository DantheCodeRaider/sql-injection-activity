...
db.serialize(function () {
    ...
    db.run("INSERT INTO user VALUES ('unprivilegedUser', 'unprivilegedUser1', 'NotTheAdministrator')");
});
...
// username:  = ' OR ''='
//password: unknown' OR '1'='1 first injection
//username: privilegedUser password: privilegedUser1'; 'SELECT * FROM user